...
class AmoebasControllerTest < ActionController::TestCase
  ...
  test "should create amoeba" do
    assert_difference('Amoeba.count') do
      post :create, amoeba: { generation: @amoeba.generation, name: @amoeba.name, specialtalent: @amoeba.specialtalent }
    end
  ...
  test "should update amoeba" do
    put :update, id: @amoeba, amoeba: { generation: @amoeba.generation, name: @amoeba.name, specialtalent: @amoeba.specialtalent }
    assert_redirected_to amoeba_path(assigns(:amoeba))
  end
